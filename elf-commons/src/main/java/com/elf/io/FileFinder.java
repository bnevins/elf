...
/**
 * base class for finding files in a file system or an archive file.
 *
 * @author bnevins
 * @version 1.0
 */
public class FileFinder implements FileFilter {
     ...
     * @param ext An array of extensions. The dot is advisable, as it does a
     * String.endsWith() to check.
     */
