...
public class ObjectAnalyzer {
    ...
    private static void setAccessible(Field[] fields) {
        ...
        try {
            ...
            Reporter.warning("Got an exception invoking setAccessible: " + e);//NOI18N
        }
    }
    ...
    private static void setupSetAccessibleMethod() {
        ...
        for (int i = 0; i < methods.length; i++) {
            ...
            {
                Reporter.fine("Found setAccessible: " + m);//NOI18N
...
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
//  ********  Holding Area for Testing Stuff .......   *********
////////////////////////////////////////////////////////////////////////////
...
/*
 ...
 System.out.println("&&&&& ObjectAnalyzer <<" + s + ">>");
 }
