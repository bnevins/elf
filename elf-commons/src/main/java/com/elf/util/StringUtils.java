...
public class StringUtils {
    ...
    public static String[] toWords(String line) {
        return toWordsInternal(line, false);
    }

    ////////////////////////////////////////////////////////////////////////////
    public static String[] toWordsLowercase(String line) {
        return toWordsInternal(line, true);
    }

    ////////////////////////////////////////////////////////////////////////////
    private static String[] toWordsInternal(String line, boolean toLowerCase) {
        String[] ww = line.split("\\W+");
        if (ww.length == 0) {
            return ww;
        }
        ArrayList<String> strings = new ArrayList<>();
        // Can't will become can and t.  't' should be stripped
        for (String s : ww) {
            if (s.length() < 2) {
                continue;
            }
            if (s.matches(".*[0-9]+.*") || s.contains("_")) {
                continue;
            } else if (toLowerCase) {
                s = s.toLowerCase();
            }
