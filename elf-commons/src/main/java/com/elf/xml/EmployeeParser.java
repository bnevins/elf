 ...
 * translates all related events into EmployeeHandler events.
 * <p>Usage sample:
 * <pre>
 ...
 *
 */
public class EmployeeParser implements ContentHandler
{
	 ...
	 */
	public EmployeeParser(final EmployeeHandler handler, final EntityResolver resolver)
	{
	...
	public final void startElement(String ns, String name, String qname, Attributes attrs) throws SAXException
	{
		...
		if ("CARS".equals(qname))
		{
			handler.start_CARS(attrs);
		} else if ("CAR".equals(qname))
		{
			handler.start_CAR(attrs);
		}
	}
	 ...
	 *
	 */
	public static void parse(final InputSource input, final EmployeeHandler handler) throws SAXException, javax.xml.parsers.ParserConfigurationException, java.io.IOException
	{
		parse(input, new EmployeeParser(handler, null));
	}
	 ...
	 *
	 */
	public static void parse(final java.net.URL url, final EmployeeHandler handler) throws SAXException, javax.xml.parsers.ParserConfigurationException, java.io.IOException
	{
		parse(new InputSource(url.toExternalForm()), handler);
	}
	
	private static void parse(final InputSource input, final EmployeeParser recognizer) throws SAXException, javax.xml.parsers.ParserConfigurationException, java.io.IOException
	{
