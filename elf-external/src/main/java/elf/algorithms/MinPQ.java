 ...
 * with a comparator instead of the natural order.
 *
 ...
 * priority queue is empty, and iterating through the keys. <p> The
 * <em>insert</em> and <em>delete-the-minimum</em> operations take logarithmic
 * amortized time. The <em>min</em>, <em>size</em>, and <em>is-empty</em>
...
public class MinPQ<Key> implements Iterable<Key> {
    ...
    *********************************************************************
     ...
     * queue in ascending order. <p> The iterator doesn't implement
     * <tt>remove()</tt> since it's optional.
     */
